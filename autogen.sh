...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tel to login script."
...
# the current dir:
if   test x${GTLANG_tel} = x ; then
	echo "WARNING: The variable \${GTLANG_tel} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tel} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tel} has the value:"
	echo "  ${GTLANG_tel}"
