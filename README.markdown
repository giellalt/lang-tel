...
This directory contains source files for the Telugu language morphology
...
-   <https://giellalt.uit.no/lang/tel/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Telugu language morphology and dictionaries,
you need:
...
The Telugu language sources can be acquired using [giella SVN
